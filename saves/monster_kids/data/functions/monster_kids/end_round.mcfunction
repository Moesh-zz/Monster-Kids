...
summon minecraft:villager_golem 129 51 3198 {CustomName:"James",CustomNameVisible:1,Tags:["Lobby","James"],NoGravity:1b,Invulnerable:1,Rotation:[45f,-50f],PersistenceRequired:1,NoAI:1,Silent:1}
