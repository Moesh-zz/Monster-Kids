...
scoreboard players tag @e[type=area_effect_cloud,name=Main,score_SuccessCount_min=1] add BlueWon
execute @e[type=area_effect_cloud,name=Main] ~ ~ ~ scoreboard players test TestRed combinedScores 0 0
scoreboard players tag @e[type=area_effect_cloud,name=Main,score_SuccessCount_min=1] add RedWon
